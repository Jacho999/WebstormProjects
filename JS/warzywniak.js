...
let wartosc=prompt("wybierz co chcesz wyszukać: "+"Lista fajek - 1 Ceny fajek - 2 Ilosc fajek - 3");
...
else if (wartosc == 3)
{
    ...
    for( let i=0;i<3;i++) {
        ...
        {
            document.write(szlugi[i].nazwa);
        document.write("Nazwa: " + szlugi[i].nazwa + " ilosc: " + szlugi[i].ilosc + " cena: " + szlugi[i].cena + "<br>");
    }
    }
}
else
