      ...
      #getPesel()
      {
        ...
        getDoB()
        {
           ...
           let str4=str.slice(2,4)-20;
            let str2='miesiac'+str4+'<BR>';
            let str3='dzien'+str.slice(4,6)+'<BR>';
            return str1+str2+str3;
            //return this.#getPesel.splice(0,6);
        }
}
    //let Student1= new Student('bob', 'marley', '459881');
    //Student1.#name=prompt('Podaj imie studenta');
    //Student1.#username=prompt('Podaj nazwisko studenta');
    //Student1.#pesel=prompt('Podaj pesel studenta');
    let student1= new student('julka', 'nowak', '032324');
   student1.display();
   //var str1='3-5';
...
Student1.#pesel=prompt('podaj pesel studenta');/
let Student1 = new  Student('bob','marley', '71070778901');
//Student1.display();
//var str1='3-5';
//var str2=new String('3-5');
//var str ='bobak';
